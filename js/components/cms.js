d.cms = {
    ...
    contactForm: '<div class="form-style" id="contact_form"><div id="contact_results"></div><div id="contact_body"><span>Hi Pradhap, my name is</span><span><input type="text" name="name" placeholder=" enter Your Name" id="name" required="true" class="input-field"><em>.</em> </span><div><span>Please contact me via email</span><span><input type="email" name="email" placeholder=" enter your email" required="true" class="input-field"></span><span> or call me at </span><span><input type="tel" name="phone2" maxlength="15" required="true" class="tel-number-field long" placeholder=" enter contact no"></span><span></span><span><em>.</em> I want to talk to you about </span><span><textarea name="message" id="message" class="textarea-field" required="true" maxlength="70" placeholder=" enter message" ></textarea></span></div><input class="submit" type="submit" id="submit_btn" value="Send It"></div></div>',
    experience: '<div><div class="item"><div class="col-1"><div class="role">Senior UI/UX Developer </div><div class="period">2018 to Present</div></div><div class="col-2"><div class="name">Clevertar, Australia</div><div class="desc">Clevertar is an Adelaide, Australian based company. Clevertar is a spin-out company from Flinders University in South Australia that uses relational agent technology to help patients better manage health conditions. <a href="https://www.clevertar.com/" target="_blank">www.clevertar.com</a></div></div></div></div><div><div class="item"><div class="col-1"><div class="role">Team Lead/Tech Lead-UI</div><div class="period">2014 to 2018</div></div><div class="col-2"><div class="name">SANA Commerce Division, ISMAPAC, Sri Lanka</div><div class="desc">ISM is a Rotterdam, Netherland based company with development centres in Ukraine and Sri Lanka. The company is fully focused on ecommerce solutions for potential clients with SanaCommerce and Magento. <a href="http://www.ism.nl" target="_blank">www.ism.nl</a></div></div></div></div><div><div class="item"><div class="col-1"><div class="role">UI Engineer</div><div class="period">2012 to 2014</div></div><div class="col-2"><div class="name">Netstarter, Sri Lanka</div><div class="desc">Ranked #1 Client Statisfaction 2013 / #2 Magento Partner 2. <a href="http://www.netstarter.com.au" target="_blank">www.netstarter.com.au</a></div></div></div></div><div><div class="item"><div class="col-1"><div class="role">Senior UI Engineer</div><div class="period">2007 - 2012</div></div><div class="col-2"><div class="name">Allion Technologies, Sri Lanka</div><div class="desc">An offshore software developemnt company with clients in Australia, Sweden and USA. <a href="http://www.alliontechnologies.com/" target="_blank">www.alliontechnologies.com</a></div></div></div></div>',
