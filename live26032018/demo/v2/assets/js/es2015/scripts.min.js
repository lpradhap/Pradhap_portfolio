...
d = function () {
    ...
    ui.navigate = {
        init: function init() {
            $(document).on('click touch', '.nav-item', function (e) {
        ...
        closeScreen: function closeScreen(_closeView, _id) {
            switch (_closeView + '-' + _id) {
                ...
                case 'about-nav-home':
                    ...
                    d.about.closer.d().then(function () {
...
d.home = function () {
    ...
    h.lion = function () {
        ...
        $('#' + d.ref._lion).load(ui.ref._imgFolder + 'lion.svg', function () {
            var count = 150;
...
d.about = function () {
    ...
    ui.socialPanel = {
        ...
        d_createSocialBlock: function d_createSocialBlock() {
        ...
        d_createContactPanel: function d_createContactPanel() {
        ...
        d_createProfile: function d_createProfile() {
            ui.socialPanel.setProfileHeight();
            $(d.sys.cssSelector(ui.socialPanel._profilePanel)).animate({
                left: 0
            }, 400);
        },
        setProfileHeight: function setProfileHeight() {
    ...
    ui.highlights = {
        ...
        createHighlights: function createHighlights() {
        ...
        t_createHighlights: function t_createHighlights() {
            var _prevView = void 0;
    ...
    ui.rightPanel = {
        ...
        d_createContainer: function d_createContainer() {
        ...
        d_experience: function d_experience() {
            ...
            $(d.sys.cssSelector(ui.rightPanel._rightExperience)).animate({
                ...
                $(d.sys.cssSelector(ui.rightPanel._rightExperience)).children('div').each(function (i, el) {
                    $(el).animate({
                        opacity: 1
                    }, d.sys.randomNo(2000));
                });
        ...
        d_qualification: function d_qualification() {
            ...
            $(d.sys.cssSelector(ui.rightPanel._rightQualification)).animate({
                ...
                $(d.sys.cssSelector(ui.rightPanel._rightQualification)).find('li').each(function (i, el) {
                    $(el).animate({
                        opacity: 1
                    }, d.sys.randomNo(3000));
                });
        ...
        d_brands: function d_brands() {
            $(d.sys.cssSelector(ui.rightPanel._rightWrapper)).removeClass('no-brand');
            var currentH = $(window).height() - ($(d.sys.cssSelector(ui.rightPanel._rightExperience)).outerHeight() + $(d.sys.cssSelector(ui.rightPanel._rightQualification)).outerHeight());
            if (currentH < 200) {
        ...
        d_brandRotator: function d_brandRotator() {
            $(d.sys.cssSelector(ui.rightPanel._rightBrands)).children(':first-child').addClass('active');
            setInterval(function () {
                var activeEl = $(d.sys.cssSelector(ui.rightPanel._rightBrands)).find('.active');
    ...
    ui.closer = {
        d: function (_d) {
            ...
            var dfd = $.Deferred();
            $(d.sys.cssSelector(ui.rightPanel._rightWrapper)).children().each(function (i, el) {
                $(el).animate({
                    right: '-100%'
                }, d.sys.randomNo(600));
            });
            ...
            $(d.sys.cssSelector(ui.socialPanel._Panel)).children().each(function (i, el) {
                $(el).animate({
                    left: '-100%'
                }, d.sys.randomNo(800));
            });
